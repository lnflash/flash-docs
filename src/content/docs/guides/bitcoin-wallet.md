...
## What the Bitcoin Wallet is for

Use the Bitcoin Wallet when you want to:
- Send Bitcoin to another wallet
- Receive Bitcoin from another wallet
- Hold Bitcoin as Bitcoin

This page is for Bitcoin send and receive only. For dollars, use the Cash Wallet.
...
:::tip
Lightning is faster and cheaper for most payments. Use on-chain only when the sender requires it.
:::
...
**My Lightning payment hasn't arrived**
