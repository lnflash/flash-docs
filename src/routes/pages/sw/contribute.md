---
title: Unga Mkono Flash
description: Tusaidie kujenga mustakabali wa Bitcoin na Lightning kwa mchango wako kwa mradi wa Flash.
---


<div class="text-center mb-12 max-w-2xl mx-auto">
  <h2 class="text-2xl font-bold mb-6">Unga Mkono Mradi wa Flash</h2>
  
  <p class="mb-6">Flash ni mradi wa chanzo huria unaojitolea kufanya Bitcoin na Lightning vipatikane kwa kila mtu. Michango yako inatusaidia kuendeleza vipengele vipya, kuboresha nyaraka, na kupanua ufikio wetu.</p>
  
  <p class="mb-10">Kila sat inahesabiwa katika kutusaidia kujenga mustakabali wa kifedha wa kujumuisha zaidi.</p>
  ...
  <div class="bg-gradient-to-r from-purple-600 to-indigo-600 p-1 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 max-w-md mx-auto">
    <a href="https://www.fygaro.com/en/pb/93b0f6b8-652f-4965-8387-2285e3c92df0/" target="_blank" rel="noopener noreferrer" class="block bg-zinc-900 hover:bg-zinc-800 transition-colors duration-200 rounded-lg py-5 px-6">
      <div class="flex items-center justify-center">
        <img src="/images/badges/png/Donate.png" alt="Changia" class="h-12 w-12 drop-shadow-[0_0_8px_rgba(168,85,247,0.8)]" />
      </div>
    </a>
  </div>
  
  <p class="mt-8 text-sm text-zinc-500 dark:text-zinc-400">
    Unataka kuchangia kwa njia zingine? Tutumiie barua pepe kwa <a href="mailto:support@getflash.io" class="text-purple-600 hover:text-purple-500 dark:text-purple-400 dark:hover:text-purple-300">support@getflash.io</a>
  </p>
</div>
