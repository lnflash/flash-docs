...
description: A step-by-step guide to getting started with Flash with the Iris web client.
---
...
1. Click on your account and then, in the Flash section, paste your new private key (this starts with `nsec`) in the field.
1. You're now ready to use Alby to log in and use Flash through any web client.

## Step 4 – Sign back into Iris

1. Back on the Iris login page, click "Flash extension login". ![Iris sign up screen](/images/iris-signup.webp)
