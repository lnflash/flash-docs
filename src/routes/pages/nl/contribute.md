---
title: Steun Flash
description: Help ons de toekomst van Bitcoin en Lightning te bouwen met uw bijdrage aan het Flash project.
---


<div class="text-center mb-12 max-w-2xl mx-auto">
  <h2 class="text-2xl font-bold mb-6">Steun het Flash Project</h2>
  
  <p class="mb-6">Flash is een open-source project gewijd aan het toegankelijk maken van Bitcoin en Lightning voor iedereen. Uw bijdragen helpen ons nieuwe functies te ontwikkelen, documentatie te verbeteren en ons bereik uit te breiden.</p>
  
  <p class="mb-10">Elke sat telt bij het bouwen aan een meer inclusieve financiële toekomst.</p>
  ...
  <div class="bg-gradient-to-r from-purple-600 to-indigo-600 p-1 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 max-w-md mx-auto">
    <a href="https://btcpay.flashapp.me/apps/3akaqK475W7thJEbzyJU2eJXa3RY/crowdfund" target="_blank" rel="noopener noreferrer" class="block bg-zinc-900 hover:bg-zinc-800 transition-colors duration-200 rounded-lg py-5 px-6">
      <div class="flex items-center justify-center">
        <img src="/images/badges/png/Donate.png" alt="Doneer" class="h-12 w-12 drop-shadow-[0_0_8px_rgba(168,85,247,0.8)]" />
      </div>
    </a>
  </div>
  
  <p class="mt-8 text-sm text-zinc-500 dark:text-zinc-400">
    Wilt u op andere manieren bijdragen? E-mail ons op <a href="mailto:support@getflash.io" class="text-purple-600 hover:text-purple-500 dark:text-purple-400 dark:hover:text-purple-300">support@getflash.io</a>
  </p>
</div>
