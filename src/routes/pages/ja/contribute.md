---
title: Flashをサポート
description: FlashプロジェクトへのあなたのContributionで、BitcoinとLightningの未来を構築するのを助けてください。
---


<div class="text-center mb-12 max-w-2xl mx-auto">
  <h2 class="text-2xl font-bold mb-6">Flashプロジェクトをサポート</h2>
  
  <p class="mb-6">Flashは、ビットコインとライトニングを誰でもアクセスできるようにすることに専念するオープンソースプロジェクトです。あなたの貢献は、新機能の開発、ドキュメントの改善、リーチの拡大に役立ちます。</p>
  
  <p class="mb-10">すべてのサトシが、より包括的な金融の未来を構築するのに役立ちます。</p>
  ...
  <div class="bg-gradient-to-r from-purple-600 to-indigo-600 p-1 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 max-w-md mx-auto">
    <a href="https://btcpay.flashapp.me/apps/3akaqK475W7thJEbzyJU2eJXa3RY/crowdfund" target="_blank" rel="noopener noreferrer" class="block bg-zinc-900 hover:bg-zinc-800 transition-colors duration-200 rounded-lg py-5 px-6">
      <div class="flex items-center justify-center">
        <img src="/images/badges/png/Donate.png" alt="寄付" class="h-12 w-12 drop-shadow-[0_0_8px_rgba(168,85,247,0.8)]" />
      </div>
    </a>
  </div>
  
  <p class="mt-8 text-sm text-zinc-500 dark:text-zinc-400">
    他の方法で貢献したいですか？<a href="mailto:support@getflash.io" class="text-purple-600 hover:text-purple-500 dark:text-purple-400 dark:hover:text-purple-300">support@getflash.io</a>にメールしてください
  </p>
</div>
